 ...
 */
@RestController
@RequestMapping("/e-elections/voter/candidats")
public class CandidatRest {
    ...
    @GetMapping("/{idVoter}")
    public ArrayList<Candidat> findCandidatsByVoterId(@PathVariable String idVoter){
        return candidatService.findCandidatsByVoterId(idVoter);
    }
}
